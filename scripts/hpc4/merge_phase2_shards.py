...
def main() -> None:
    ...
    phase1_solved = sum(1 for r in merged_first_sorted if r.get("is_solved") is True)
    phase2_solved = sum(1 for r in merged_second_sorted if r.get("is_solved") is True)
