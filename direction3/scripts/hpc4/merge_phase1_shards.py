...
def main() -> None:
    ...
    parser.add_argument(
        "--skip_recompute",
        action="store_true",
        help="Skip phase1 solved re-evaluation to speed up pipeline; phase2 merge will still compute final metrics.",
    )
    parser.add_argument(
    ...
    with open(results_txt_path, "w", encoding="utf-8") as f:
        ...
        if args.skip_recompute:
            f.write(f"phase1_solved: N/A/{len(dataset_rows)}\n")
            f.write("phase1_acc: N/A%\n")
        else:
